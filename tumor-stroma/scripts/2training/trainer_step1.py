...
fname="unet-resnet34_before-unfreeze-WD-1_BS{}_{}".format(BS, timeStamp)
early_fname = 'best_'+fname

callbacks_Before_Unfreeze=[CSVLogger(fname=fname+'.csv') ,ShowGraphCallback(),
...
learn.fit_flat_cos(20, slice(lr),cbs=callbacks_Before_Unfreeze)

modelPath = opj(projectDir,'models',fname+'_stage-1')
...
res_plot_path = opj(outputDir,'plots',fname+'results_stage-1.png')
